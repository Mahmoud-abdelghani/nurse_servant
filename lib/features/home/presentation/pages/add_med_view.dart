...
class _AddMedViewState extends State<AddMedView> {
  ...
  GlobalKey<FormState> rebeatKey = GlobalKey<FormState>();
  ...
  TextEditingController textEditingControllerRebeate = .new();
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<LoadFromHiveCubit, LoadFromHiveState>(
      listener: (context, state) {
        if (state is LoadFromHiveSuccess) {
        ...
        return BlocConsumer<LoadFromHiveCubit, LoadFromHiveState>(
          listener: (context, state) async {
            if (state is LoadToHiveLoading) {
              ...
              await BlocProvider.of<LoadFromHiveCubit>(
                context,
              ).getDataFromHive();
                              ...
                              children: [
                                ...
                                CustomInputField(
                                  ...
                                  label:
                                      ...
                                      ? 'ساعة'
                                      : 'hour',
                                  fieldController: textEditingControllerRebeate,
                                  isPassword: false,
                                  textInputType: TextInputType.number,
                                  validator: (value) {
                                    if (value!.isEmpty) {
                                      return 'enter rebeation period';
                                    } else if (int.parse(value) > 24 ||
                                        int.parse(value) < 2) {
                                      return 'enter a period between 2 ~ 23';
                                    } else {
                                      return null;
                                    }
                                  },
                                        ...
                                        child: CustomSelectionContainer(
                                          ...
                                          txt:
                                              Localizations.localeOf(
                                                  ...
                                                  'ar'
                                              ? 'ادخل ميعاد انتهاء الجرعة'
                                              : 'Enter the dose ending date.',
                              ...
                              onTap: () {
                                ...
                                if (MediaQuery.of(context).viewInsets.bottom ==
                                  ...
                                  if (nameKey.currentState!.validate() ||
                                      ...
                                      rebeatKey.currentState!.validate()) {}
                                  if (nameKey.currentState!.validate() &&
                                      doseKey.currentState!.validate() &&
                                      amountKey.currentState!.validate() &&
                                      rebeatKey.currentState!.validate()) {
                                    if (Localizations.localeOf(
                                      ...
                                      BlocProvider.of<LoadFromHiveCubit>(
                                        ...
                                        MedicineModel(
                                          ...
                                          rebeatEvery:
                                              '${textEditingControllerRebeate.text}:00',
                                          nextDose: DateFormat(
                                            'HH:mm',
                                          ).format(selectedTime!),
                                        ),
